...
#Hello Brother My Problem Is Here When I Close Entry Box For Alphabet My Operation Dont Work
# This Fuction Is For You Entry Box Just Accept Numbers
def only_numbers(char):
    return char.isdigit()
# And Here Put This Variable That We put For Register That Function Inside With Config Inside Entry Box For Just Accept Numbers
reg = win.register(only_numbers)
# And Here Register This Fuction In Window
en.config(validate = "key" , validatecommand = (reg , '%S'))
en1.config(validate = "key" , validatecommand = (reg , '%S'))
